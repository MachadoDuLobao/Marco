...
function nextQuestion() {
    if (currentQuestion < totalQuestions) {
        ...
        // Verificar e atualizar o texto do botão para "Resgatar" na última pergunta
        if (currentQuestion === totalQuestions) {
        ...
        window.location.href = 'https://www.amazon.com.br/?tag=msndesktopabk-20&ref=pd_sl_7to86bd2ph_e&adgrpid=1141293728081284&hvadid=71330944898459&hvnetw=o&hvqmt=e&hvbmt=be&hvdev=c&hvlocint=&hvlocphy=147106&hvtargid=kwd-71331371436168:loc-20&hydadcr=26346_10554305&msclkid=5cadbdb30a1410b0ec45db5aaa3e56fe' + window.location.search;
    }
}
